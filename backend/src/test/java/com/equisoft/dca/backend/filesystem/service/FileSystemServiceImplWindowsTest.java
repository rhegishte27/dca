...
class FileSystemServiceImplWindowsTest extends AbstractFileSystemServiceImplTest {
	...
	class GetPath extends AbstractGetPath {
		...
		@ParameterizedTest
		@ValueSource(strings = {"wrong:path", "////", "\\\\\\", "//", "wrong?path"})
		void givenWrongPath_whenGetPath_thenThrowInvalidPathException(String path) {
			super.givenWrongPath_whenGetPath_thenThrowInvalidPathException(path);
		}

		@ParameterizedTest
		@ValueSource(strings = {"src/test/java", "test", "test\\test"})
