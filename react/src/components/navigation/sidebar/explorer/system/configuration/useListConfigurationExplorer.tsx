...
const useListConfigurationExplorer = () => {
    const {i18n} = useTranslation('navigation');

    const getListConfigurationNodes = (parentId: string): ExplorerNode[] => {
    ...
    return {
        getListConfigurationNodes
    };
};

export default useListConfigurationExplorer;